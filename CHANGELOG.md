...
* Initial scaffold from Flutter package template.

## 0.1.0

* Add `TagaddodShakerHost` to wrap any app with `RequestsInspector`.
* Add `TagaddodShakerController` for show/hide/clear/manual request logs.
